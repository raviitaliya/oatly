...
const SignUp = () => {
  ...
  const { signUpUser, loading, error, isSignUpOpen, openSignIn } =
    useProductStore();
  const openSignUp = useProductStore((state) => state.openSignUp);
  ...
  return (
    isSignUpOpen && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        {/* <div className="fixed inset-0 z-40" onClick={closeSignUp} /> */}
      </div>
    )
  );
};
