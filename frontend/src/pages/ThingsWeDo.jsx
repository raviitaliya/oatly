  ...
  const storiesData = [
    {
      ...
      description: "The New York pastry chef came up with three fall recipes that feature Oatly, and they’re delicious. Trust us—we tasted them.",
      date: "NOV 6, 2023",
      category: "STORIES",
      image: story13,
    },
    {
      ...
      description: "When we learned an old dairy truck in Illinois had been mutated into a dragster, we asked a simple question: Will Oatly make it faster?",
      date: "JUL 12, 2023",
      category: "STORIES",
      image: story14,
    },
    {
      ...
      description: "We convinced a Louisiana diner to swap dairy with Oatly in their most popular dishes. Almost everyone enjoyed the Oatly jambalaya and crawfish fettuccine, except for a few individuals who asked to be removed from the video.",
      date: "MAY 18, 2023",
    ...
    },
    {
      ...
      description: "More than just a clever acronym, the F.A.R.M. is a global initiative that works with farmers toward solutions in regenerative agriculture.",
      date: "MAY 10, 2023",
      category: "STORIES",
      image: story16,
    },
        ...
        {story.map(({ id, title, description, date, category, image }) => (
          <div key={id} className="flex flex-col">
            ...
            <div className="mt-4">
              ...
              <p className="text-lg font-font2 font-semibold t-2">{description}</p>
        ...
        {storiesData.map(({ id, title, description, date, category, image }) => (
          ...
          >
            ...
            <div className="mt-3">
              ...
              <p className="text-sm font-font2 font-semibold mt-1">{description}</p>
          ...
          {stories.map((story) => (
            <div key={story.id} className="space-y-4">
              ...
              <div>
                ...
                <p className=" text-lg mt-2 font-font2">{story.description}</p>
