...
import backgroundImage from "../assets/Footer/back1.jpg";
...
const imagesss = [img9, img10, img11, img12];
      ...
      <div className="relative w-full h-screen ">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
          ...
          <p className="mt-4 text-sm md:text-2xl font-mono max-w-2xl">
            And how a daring group of corn and soy farmers are bringing back the
            Midwest’s soil with an old idea.
          </p>
        </div>
      </div>
      <div>
        <div className="max-w-4xl mx-auto px-4  py-12">
          ...
          <h1 className="text-4xl md:text-8xl font-font1  text-black text-center  my-12">
            “WHY ARE ALL OUR OATS <br /> COMING FROM CANADA?”
          </h1>
