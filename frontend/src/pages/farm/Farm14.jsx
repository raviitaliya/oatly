...
import progress from "../../assets/Footer/farm-progress-13.svg";
  ...
  return (
    <div>
       ...
       ***And, yes, “regenerative” and “renovation” are similar words, which makes the acronym hard to remember. We understand.**** 
              ...
              <p className="absolute bottom-[200px] text-center w-[1200px] font-font2 text-2xl px-2 bg-black text-white ">
                
              ****But we’ve committed to it at this point, so there’s no turning back—and we’ve chosen to be comfortable with that reality. 
                       </p>
            </div>
    </div>
  )
