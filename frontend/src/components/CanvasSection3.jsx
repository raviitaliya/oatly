  ...
  return (
    <div className="relative sm:w-[10vh] w-[44.844vh] left-[60vh]">
      ...
      <a
        href="/products"
        aria-label="/products"
        className="absolute w-[28.86vh] left-0 top-[1%] block transition-transform hover:scale-105 cursor-hand"
      >
        <img
          src={stuffwemake}
          alt="Stuff we make"
      ...
      <a
        ...
        className="absolute w-[42.18vh] left-[-1.776vh] top-[43%] block transition-transform hover:scale-105 cursor-hand"
      >
        <img
          src={header}
      ...
      <a
        ...
        className="absolute w-[22.644vh] left-[-4.44vh] bottom-[2%] block transition-transform hover:scale-105 cursor-hand"
      >
        <img
          src={oatlyWho}
